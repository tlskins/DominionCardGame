...
RSpec.describe User, type: :model do
  ...
  describe "validity by attributes" do
    before :each do
      @user = FactoryGirl.create(:user, name: "Gymothy", email: "timothy123456@gmail.com")
    end

    context "duplicate email address" do
      it "is invalid" do
        dup_user = FactoryGirl.build(:user, email: "timothy123456@gmail.com")
    ...
    context "duplicate name" do
      it "is valid" do
        dup_user = FactoryGirl.build(:user, name: "Timothy")
        dup_user.valid?
